 ...
 * @copyright CiviCRM LLC (c) 2004-2018
 */
class CRM_Dogregistry_Form_Report_Dog_Contact_Summary extends CRM_Report_Form {
  ...
  public function __construct() {
    ...
    $this->_columns = array(
      ...
      'civicrm_registered_dogs' => array(
    'dao' => 'CRM_Dogregistry_DAO_RegisteredDogs',
    'fields' => array(
      'id' => array(
      'title' => ts('Dog Number'),
      'required' => FALSE,
  ...
  public function from() {
    ...
    $this->joinRegisteredDog();
  }
  public function joinRegisteredDog($prefix = '', $extra = array()) {
      $this->_from .= "
                 LEFT JOIN civicrm_registered_dogs {$this->_aliases[$prefix . 'civicrm_registered_dogs']}
                           ON ({$this->_aliases[$prefix . 'civicrm_contact']}.id =
                               {$this->_aliases[$prefix . 'civicrm_registered_dogs']}.contact_id)\n";
